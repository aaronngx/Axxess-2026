...
import { EmergencyContact } from '../services/MockDataService';
import * as Haptics from 'expo-haptics';
import { useAppContext } from '../context/AppContext';

export const EmergencyScreen: React.FC = () => {
  const insets = useSafeAreaInsets();
  const { emergencyContacts: contacts, addEmergencyContact, updateEmergencyContact, deleteEmergencyContact } = useAppContext();
  ...
  const saveContact = () => {
    ...
    if (editingContact) {
      // Edit
      updateEmergencyContact({ ...editingContact, name, relationship, phone });
    } else {
      // Add
  ...
  return (
    <View style={styles.root}>
      ...
      <LinearGradient colors={['#161925', '#D33F49', '#161925']} style={StyleSheet.absoluteFill} />
      ...
      >
        ...
        <TouchableOpacity onPress={handleSOS} activeOpacity={0.85} style={styles.sosBtnWrapper}>
          <LinearGradient
            colors={sosActive ? ['#7f0000', '#D33F49'] : ['#D33F49', '#7f0000']}
            style={styles.sosBtn}
          >
            ...
            <LinearGradient colors={['#1A1A2E', '#16213E']} style={styles.modalContent}>
              ...
              <View style={styles.modalActions}>
                ...
                <TouchableOpacity style={styles.saveBtn} onPress={saveContact}>
                  <LinearGradient colors={['#235789', '#42CAFD']} style={styles.saveBtnGradient}>
...
const styles = StyleSheet.create({
  ...
  call911Btn: {
    backgroundColor: 'rgba(211, 63, 73, 0.45)', borderRadius: 24,
    paddingVertical: 18, alignItems: 'center', marginBottom: 28,
    borderWidth: 1.5, borderColor: 'rgba(255, 255, 255, 0.3)',
    shadowColor: '#000', shadowOffset: { width: 0, height: 4 },
    shadowOpacity: 0.3, shadowRadius: 8, elevation: 6,
  },
  call911Text: { fontSize: 20, fontWeight: '900', color: '#FFFFFF' },
  sectionHeader: {
    flexDirection: 'row',
  ...
  contactAvatar: {
    ...
    backgroundColor: '#235789', alignItems: 'center', justifyContent: 'center',
    marginRight: 14,
  },
  contactInitial: { fontSize: 20, fontWeight: '800', color: '#FFFFFF' },
  contactInfo: { flex: 1 },
  contactName: { fontSize: 16, fontWeight: '700', color: '#FFFFFF' },
  contactRelation: { fontSize: 12, color: '#42CAFD', fontWeight: '600', marginTop: 2 },
  ...
  smsBtn: { backgroundColor: 'rgba(35, 87, 137, 0.2)' },
